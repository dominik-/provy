...
nohup /home/ubuntu/ycsb/ycsb-0.1.4/bin/ycsb run hbase -P $workload_file -p operationcount=$number_of_requests -target $5 -p maxexecutiontime=$4 -threads $6 -s >> /mnt/experiment-data/$1/$2.dat &
exit
